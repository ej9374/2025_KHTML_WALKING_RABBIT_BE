...
- 사용자가 촬영한 식물을 **AI 챗봇**이 인식하고 대화형 설명을 제공
...
- AI 미션 생성 모델 API 연동 및 서비스 로직 개발
- 사진 업로드 및 식물 인식 AI 모델 연동 챗봇 기능 구현
- 발견한 식물의 날짜별·위치별 도감 기록 및 조회 기능 설계 및 개발
- 도감 수에 따른 랭킹 기능 구축
- AWS EC2 배포 환경 설정 및 서비스 운영
